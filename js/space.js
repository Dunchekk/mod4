...
var sizes = {
    ...
    height1: window.innerHeight * 1,
    height2: window.innerHeight * 1,
    };
    ...
    window.addEventListener('resize', () =>  {
            ...
            sizes.height1 = window.innerHeight * 1;
            sizes.height2 = window.innerHeight * 1;
...
var paths = {
    "model_cube1" : "./support/models/1_3mod.glb",
    "model_cube2" : "./support/models/1_4mod.glb",  
}

// -- camera

const camera1 = new THREE.PerspectiveCamera(50, sizes.width1 / sizes.height1, 0.01, 30);
const camera2 = new THREE.PerspectiveCamera(50, sizes.width2 / sizes.height2, 0.01, 30);
...
scene1.add(dL11)
scene1.add(dL12)
camera1.position.set(0, 15, 0.55);

scene2.add(dL21)
scene2.add(dL22)
camera2.position.set(0, 15, 0.55);
